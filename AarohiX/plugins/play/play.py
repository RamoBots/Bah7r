...
async def play_commnd(
    ...
    plist_type = None
    spotify = None
    user_id = message.from_user.id if message.from_user else "5490392130"
    user_name = message.author_signature if message.author_signature else message.chat.title
    audio_telegram = (
