...
GAME_MESSAGE = "⩹━★⊷━⌞ѕᴏụʀᴄᴇ Riko⌝━⊶★━⩺\n\n★¦ مرحبا بك عزيزي:\n★¦في قسم العاب ريكو\n\n⩹━★⊷━⌞ѕᴏụʀᴄᴇ Riko⌝━⊶★━⩺"
GAME_BUTTONS = [
    [ 
        InlineKeyboardButton ('★¦العاب 3D', callback_data= 'GAME1'),
        InlineKeyboardButton ('Riko', callback_data= 'GAME2'),
        ],[
        InlineKeyboardButton ('⌞ѕᴏụʀᴄᴇ Riko⌝⚡️', url =f"https://t.me/R_surce")              
                 ],[
...
async def AarohiX(client: Client, message: Message):
    await message.reply_photo(
                photo=f"5https://graph.org/file/ade261f5d3f04d0bffa04.jpg",
...
async def callback_query(client, CallbackQuery):
          if CallbackQuery.data == "GAME1":
             ...
             GAME1_MESSAGE = "⩹━★⊷━⌞ѕᴏụʀᴄᴇ Riko⌝━⊶★━⩺\n\nمرحبا بك في قسم العاب ريكو 3D\n\n⩹━★⊷━⌞ѕᴏụʀᴄᴇ Riko⌝━⊶★━⩺"
             ...
             await CallbackQuery.edit_message_text( 
               ...
               RETURN_GAME = "⩹━★⊷━⌞ѕᴏụʀᴄᴇ Riko⌝━⊶★━⩺\n\n★¦مرحبا بك في قسم العاب ريكو\n★¦اختار ما تشاء من الالعاب مسليه وستمتع بها\n\n⩹━★⊷━⌞ѕᴏụʀᴄᴇ Riko⌝━⊶★━⩺" 

               RETURN_BUTTON = [
                    [ 
                      InlineKeyboardButton ('★¦العاب 3D', callback_data= 'GAME1'),
                      InlineKeyboardButton ('★¦العاب ريكو', callback_data= 'GAME2')
                      ],[
        InlineKeyboardButton ('⌞ѕᴏụʀᴄᴇ Riko⌝⚡️', url =f"https://t.me/R_surce")              
                 ],[
                InlineKeyboardButton(
