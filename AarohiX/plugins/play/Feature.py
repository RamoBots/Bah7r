...
@app.on_message(
    filters.command(["مميزات","مميزات ريكو"], "")
& filters.group
 )
async def mmmezat(client, message):
        await message.reply_text(f"""**مرحبآ بك عزيزي » {message.from_user.mention}**في قسم مميزات سورس ريكو\n
⩹━★⊷⌯⌞ SOURCE Riko ⌝⌯⊶★━⩺

★قايمه مميزات سورس ريكو 
            ...
            [
                [
                    InlineKeyboardButton(
                        "★⌞ SOURCE Riko ⌝⚡", url=f"https://t.me/R_surce"),                        
                 ],[
                InlineKeyboardButton(
