...
async def get_thumb(videoid):
    try:
        ...
        if 1 == 1:
            ...
            image4.text((11, 11), "Source VR", fill="white", font = font1, align ="left"
            )
            image4.text(
                (670, 150),
                "VR PlAYiNg",
            ...
            image4.text(
                (670, 600), "DEV : VR", fill="white", font=font4, align="left"
            )

            image2 = ImageOps.expand(image2, border=0)
